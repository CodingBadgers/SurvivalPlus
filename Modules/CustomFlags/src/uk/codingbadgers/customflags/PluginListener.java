...
import uk.codingbadgers.customflags.flags.CustomLocationFlag;
import uk.codingbadgers.customflags.flags.CustomSetFlag;
import uk.codingbadgers.customflags.flags.CustomVectorFlag;
...
{
    private CustomFlags custPlugin;

    public PluginListener(CustomFlags plug)
    {
