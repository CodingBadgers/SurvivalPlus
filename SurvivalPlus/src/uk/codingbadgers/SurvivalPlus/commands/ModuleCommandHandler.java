...
import uk.codingbadgers.SurvivalPlus.commands.annotations.Command;
import uk.codingbadgers.SurvivalPlus.commands.annotations.Parent;
import uk.codingbadgers.SurvivalPlus.commands.annotations.Permission;
import uk.codingbadgers.SurvivalPlus.commands.annotations.TabCompletion;
import uk.codingbadgers.SurvivalPlus.commands.executors.AnnotationCommandExecutor;
import uk.codingbadgers.SurvivalPlus.commands.executors.AnnotationTabCompleter;
import uk.codingbadgers.SurvivalPlus.commands.executors.LegacyCommandExecutor;
import uk.codingbadgers.SurvivalPlus.commands.utils.AnnotatedCommandInfo;
 ...
 * be used outside SurvivalPlus</b>.
 *
        ...
        for (ModuleCommand command : commands) {
            ...
            try {
                ...
                if (SurvivalPlus.getConfigurationManager().isDebugEnabled()) {
                    SurvivalPlus.log(Level.INFO, theCommand.getLabel().toLowerCase() + " for module " + module.getName() + " has been deregistering successfully");
                }
            } catch (Throwable e) {
                SurvivalPlus.log(Level.INFO, "Error deregistering " + command.getName() + " for module " + module.getName(), e);
            }
        }
    }
