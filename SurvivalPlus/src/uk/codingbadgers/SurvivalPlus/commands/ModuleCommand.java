...
import uk.codingbadgers.SurvivalPlus.commands.executors.ModuleCommandExecutor;
...
public class ModuleCommand extends Command implements TabExecutor {
    ...
    public ModuleCommand(String label, String usage) {
        ...
        m_permission = "survivalplus.command." + m_label;
    ...
    protected void sendMessage(CommandSender sender, String message) {
        Module.sendMessage(m_module == null ? SurvivalPlus.getInstance().getName() : m_module.getName(), sender, message);
    }
}
