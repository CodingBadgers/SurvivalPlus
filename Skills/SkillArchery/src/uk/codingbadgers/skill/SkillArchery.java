...
public class SkillArchery extends SkillBase implements Listener {
    ...
    public void OnEntityDamanged(EntityDamageByEntityEvent event)
    {
        ...
        FundamentalPlayer player = SurvivalPlus.Players.getPlayer((Player)source);
        if (player == null) {
            return;
        }
